<div class="main-layout">
    <aside id="sidebar" class="card">
        <nav>
            <div class="sidebar-list">
                <div><a href="#1">Información al usuario</a></div>
                <div><a href="#2">Contacto</a></div>
                <div><a href="#3">Principios clave</a></div>
                <div><a href="#4">Recogida y tratamiento de datos personales</a></div>
                <div><a href="#5">Legitimidad</a></div>
                <div><a href="#6">Comunicación de datos personales</a></div>
                <div><a href="#7">Sus derechos</a></div>
                <div><a href="#8">Información legal</a></div>
            </div>
        </nav>
    </aside>
    <section id="principal">
        ...
        <p>
            RECIPEDIUM S.L., como Responsable del Tratamiento, le informa que, según lo dispuesto en el Reglamento (UE)
            2016/679, de 27 de abril, (RGPD) y en la L.O. 3/2018, de 5 de diciembre, de protección de datos
            y garantía de los derechos digitales (LOPDGDD), trataremos su datos tal y como reflejamos en la presente
            Política de Privacidad.
        </p>
        <p>
            En esta Política de Privacidad describimos cómo recogemos sus datos personales y por qué los
            recogemos, qué hacemos con ellos, con quién los compartimos, cómo los protegemos y sus opciones en cuanto
            al tratamiento de sus datos personales.
        </p>
        <p>
            Esta Política se aplica al tratamiento de sus datos personales recogidos por la empresa para la
            prestación de sus servicios. Si acepta las medidas de esta Política, acepta que tratemos sus datos personales
            como se define en esta Política.
        </p>
        <p id="2">2. CONTACTO</p>
        <p>
            Denominación social: RECIPEDIUM S.L.<br>
            Nombre comercial: RECIPEDIUM<br>
            CIF: B-04858585<br>
            Domicilio: SAN ISIDRO LABRADOR 30, 04720, ALMERÍA, ESPAÑA<br>
            e-mail: recipedium@gmail.com
        </p>
        <p id="3">3. PRINCIPIOS CLAVE</p>
        <p>
            Siempre hemos estado comprometidos con prestar nuestros servicios con el más alto grado de
            calidad, lo que incluye tratar sus datos con seguridad y transparencia. Nuestros principios son:
        </p>
        <ul>
        ...
        <p id="4">4. RECOGIDA Y TRATAMIENTO DE SUS DATOS PERSONALES</p>
        <p>
            Las tipos de datos que se pueden solicitar y tratar son:
            <br><br>
            Datos de carácter identificativo. También recogemos de forma automática datos sobre su visita a nuestro sitio web según se describe en la política de cookies.
        </p>
        <p>
        ...
        <p id="6">6. COMUNICACIÓN DE DATOS PERSONALES</p>
        <p>
        ...
        <p>
            Puede ejercer estos derechos enviando comunicación, motivada y acreditada, a recipedium@gmail.com
            <br><br>
